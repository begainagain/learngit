...
//      switch (content) {
//        case "1":
//          return new TextBuilder().build("你好，您输入的是1。", wxMessage, weixinService);
//        case "2":
//          return new TextBuilder().build("你好，您输入的是2。", wxMessage, weixinService);
//        case "3":
//          return new TextBuilder().build("你好，您输入的是3。", wxMessage, weixinService);
//        default:
